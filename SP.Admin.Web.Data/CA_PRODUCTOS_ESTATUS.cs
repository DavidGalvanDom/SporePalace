...
namespace SP.Admin.Web.Data
{
    ...
    public partial class CA_PRODUCTOS_ESTATUS
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CA_PRODUCTOS_ESTATUS()
        {
            this.CA_PRODUCTOS = new HashSet<CA_PRODUCTOS>();
        }
    
        public int PRE_KEYPRE { get; set; }
        public string PRE_CVEPRE { get; set; }
        public string PRE_DESCRI { get; set; }
        public System.DateTime PRE_FEULAC { get; set; }
        public System.DateTime PRE_FECALT { get; set; }
