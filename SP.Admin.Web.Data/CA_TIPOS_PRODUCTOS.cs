...
namespace SP.Admin.Web.Data
{
    ...
    public partial class CA_TIPOS_PRODUCTOS
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CA_TIPOS_PRODUCTOS()
        {
            this.CA_PRODUCTOS = new HashSet<CA_PRODUCTOS>();
        }
    
        public int TPR_KEYTPR { get; set; }
        public string TPR_CVETPO { get; set; }
        public string TPR_DESCRI { get; set; }
        public System.DateTime TPR_FEULAC { get; set; }
        public System.DateTime TPR_FECALT { get; set; }
