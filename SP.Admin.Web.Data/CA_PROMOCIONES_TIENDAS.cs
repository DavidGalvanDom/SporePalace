...
namespace SP.Admin.Web.Data
{
    ...
    public partial class CA_PROMOCIONES_TIENDAS
    {
        public int PMT_KEYIDE { get; set; }
        public int TIE_KEYTIE { get; set; }
        public int PRO_KEYPRO { get; set; }
        public System.DateTime PMT_FEULAC { get; set; }
        public System.DateTime PMT_FECALT { get; set; }
