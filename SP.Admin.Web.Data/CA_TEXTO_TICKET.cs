...
namespace SP.Admin.Web.Data
{
    ...
    public partial class CA_TEXTO_TICKET
    {
        public int TET_KEYTET { get; set; }
        public int TIE_KEYTIE { get; set; }
        public string TDO_KEYTDO { get; set; }
        public string TET_TEXTOT { get; set; }
        public System.DateTime TET_FECALT { get; set; }
        public System.DateTime TET_FEULAC { get; set; }
