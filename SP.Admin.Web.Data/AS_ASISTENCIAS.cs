...
namespace SP.Admin.Web.Data
{
    ...
    public partial class AS_ASISTENCIAS
    {
        public int ASI_KEYASI { get; set; }
        public int TIE_KEYTIE { get; set; }
        public int USR_KEYASI { get; set; }
        public System.DateTime ASI_FECALT { get; set; }
        public System.DateTime ASI_FEULAC { get; set; }
